...
object CliRendering {
    fun helpText(): String =
        ...
        Usage:
          ...
          mission-recorder record screen --output out.mp4 [--duration 3s] [--fps 30] [--mic ID|default] [--mic-gain 0..200] [--system-audio] [--system-audio-endpoint ID] [--system-audio-gain 0..200] [--no-cursor] [--show-input] [--overwrite] [--control-endpoint PATH]
          mission-recorder record profile --settings mission-recorder.settings.json [--profile default] [--output out.mp4] [--duration 3s] [--show-input|--hide-input]
          mission-recorder record monitor --id ID --output out.mp4 [--duration 3s] [--fps 30] [--no-cursor] [--show-input]
          mission-recorder record region --x X --y Y --width W --height H --output out.mp4 [--duration 3s] [--no-cursor] [--show-input]
          mission-recorder record window --id ID --output out.mp4 [--duration 3s] [--no-cursor] [--show-input]
          mission-recorder record app --id ID --output out.mp4 [--duration 3s] [--show-input]
          mission-recorder replay run screen --buffer 5m --output replay.mp4 [--run-for 30m] [--mic ID|default] [--mic-gain 0..200] [--system-audio] [--system-audio-endpoint ID] [--system-audio-gain 0..200] [--show-input] [--control-endpoint PATH]
          mission-recorder replay run window --id ID --buffer 5m --output replay.mp4 [--run-for 30m] [--show-input]
